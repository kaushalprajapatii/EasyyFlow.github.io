# --- I Layout with Transparency Support ---
...
def create_flowchart(steps, figsize=None, preview_mode=False,
    ...
    for i, (title, description, color) in enumerate(steps):
        ...
        wrapped_desc = wrap_text(description, desc_wrap or 28)
...
if __name__ == "__main__":
    steps = [
        ("Input", "Load data and initialize process", "#fbc02d"),
        ("Preprocess", "Clean and prepare data", "#4db6ac"),
        ("Train", "Train the model with dataset", "#ba68c8"),
        ("Evaluate", "Assess model performance", "#ff7043"),
    ]
