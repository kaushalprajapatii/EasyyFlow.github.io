# --- H Layout with Transparency Support ---
...
if __name__ == "__main__":
    steps = [
        ("Input", "User provides initial data", "#fbc02d"),
        ("Process", "System processes and validates data", "#4db6ac"),
        ("Output", "Generate and display final results", "#ba68c8"),
        ("End", "Complete workflow execution", "#ff7043"),
    ]
