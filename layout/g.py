# --- G Layout with Transparency Support ---
...
def create_flowchart(steps, figsize=None, preview_mode=False,
    ...
    for i, (title, description, color) in enumerate(steps):
        ...
        # Main box with adjustable transparency
...
if __name__ == "__main__":
    steps = [
        ("Collect Data", "Gather information from multiple sources", "#fbc02d"),
        ("Process Data", "Clean and transform into usable form", "#4db6ac"),
        ("Train Model", "Use ML algorithms to learn patterns", "#ba68c8"),
        ("Evaluate", "Test on unseen data and optimize", "#ff7043"),
    ]
